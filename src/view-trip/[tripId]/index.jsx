        ...
        <div className='pt-[72px] p-10 md:px-20 lg:px-44 xl:px-56'>
            {visibleSections.info && (
                <div className="animate-fadeIn">
                    ...
                    <div className={`transition-all duration-300 ease-in-out overflow-hidden ${
                        expandedSections.info ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
                    }`}>
            ...
            {visibleSections.flights && (
                <div className="animate-fadeIn">
                    ...
                    />
                    <div className={`transition-all duration-300 ease-in-out overflow-hidden ${
                        expandedSections.flights ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
                    }`}>
                        <Flights trip={trip} />
                    </div>
                </div>
            ...
            {visibleSections.hotels && (
                <div className="animate-fadeIn">
                    ...
                    />
                    <div className={`transition-all duration-300 ease-in-out overflow-hidden ${
                        expandedSections.hotels ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
                    }`}>
                        <Hotels trip={trip} />
                    </div>
                </div>
            ...
            {visibleSections.activities && (
                <div className="animate-fadeIn">
                    ...
                    />
                    <div className={`transition-all duration-300 ease-in-out overflow-hidden ${
                        expandedSections.activities ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
                    }`}>
            ...
            {visibleSections.weather && (
                <div className="animate-fadeIn">
                    ...
                    />
                    <div className={`transition-all duration-300 ease-in-out overflow-hidden ${
                        expandedSections.weather ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'
                    }`}>
                        <WeatherForecast 
